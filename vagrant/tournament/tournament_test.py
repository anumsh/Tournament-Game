...
# this file will check the various test cases on various
#functions defined in tournament.py file

# importing all the files(tournament.sql and tournamant.py) from tournament module
